...
use cosmwasm_std::{
    ensure, ensure_eq, to_json_binary, Binary, Deps, DepsMut, Env, MessageInfo,
    StdResult, WasmMsg,
};
...
use crate::msg::{
    ExecuteMsg, InstantiateMsg, ParamsResponse, SudoMsg, MetadataMinterCreateMsg,
    MetadataUpdateParamsMsg,
};
...
pub fn sudo_update_params(
    deps: DepsMut,
    _env: Env,
    param_msg: MetadataUpdateParamsMsg,
) -> Result<Response, ContractError> {
